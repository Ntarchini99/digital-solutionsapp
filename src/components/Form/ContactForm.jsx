...
export const ContactForm = () => {
    ...
    return (
        <section>
            <motion.div
                className={`bg-white block fixed inset-0 ${isFormVisible ? 'z-50' : 'z-40'} `}
                    ...
                    <form className='mx-auto' onSubmit={handleSubmit(handleSave)}>
                        <div
                            ...
                            <div className='flex flex-col'>
                                ...
                                <div className='flex flex-col 2xs:px-4 sm:px-0'>
                                    <button type='submit' className={`mx-2 2xs:my-4 sm:mb-0 bg-white sm:px-6 sm:py-4 2xs:px-4 2xs:py-3 rounded-full text-white hover:bg-white transition duration-500
                                        ${isLoading
