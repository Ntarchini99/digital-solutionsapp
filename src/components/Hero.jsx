...
export const Hero = () => {
    ...
    return (
        <section className=' 2xs:px-[1rem] md:px-[6rem] xl:px-[16rem] 2xl:px-[28rem] 3xl:px-[32rem] sm:pt-20 2xs:pt-10 pb-60'>
            <motion.div
                className={`fixed top-0 right-0 w-full h-[100vh] bg-black flex items-center justify-center overflow-hidden z-[44] `}
                initial={{ x: '0%' }}
                animate={controls}
            ...
            <div className='flex sm:flex-row 2xs:flex-col justify-between items-center w-full overflow-hidden heroo'>
                ...
                <div className='sm:w-1/2 2xs sm:flex mt-15'>
                    <img src={hero} alt="hero" className='w-[100%] bg-cover hero' />
                </div>
            </div>
        </section>
    )
