...
export const Process = () => {
    ...
    return (
        <section className='2xs:px-[1rem] md:px-[6rem] xl:px-[16rem] 2xl:px-[28rem] 3xl:px-[32rem]  overflow-hidden'>
            <motion.div
                className='flex flex-col sm:my-20 2xs:mt-20 2xs:mb-0'
                ref={processRef}
                animate={animation}
            >
                <p className='text-blue-400 font-bold text-lg sm:mx-auto sm:py-2'>Nuestro proceso</p>
                <h2 className='text-white font-semibold xs:text-4xl 2xs:text-2xl sm:mx-auto'>¿Como funciona?</h2>
            </motion.div>
            <div className='flex flex-col'>
                ...
                >
                    <div className='sm:w-1/2'>
                        <div className='flex flex-col border-[1px] rounded-md bg-blue-light border-blue-light px-8 py-6 mr-2 mb-2'>
                            <p className='text-blue-400 font-semibold text-lg py-1'>Paso 1</p>
                            <h3 className='text-white font-semibold text-xl pb-4'>Descubrir y definir</h3>
                            <p className='text-white'>Comenzamos sumergiéndonos en su visión y objetivos. Con un gran enfoque en sus necesidades de desarrollo web, entenderemos su negocio de cerca, llevaremos a cabo investigaciones exhaustivas y participaremos en diálogos profundos para delinear el camino hacia su triunfo digital..</p>
                        </div>
                    </div>
                ...
                >
                    ...
                    <div className='sm:w-1/2'>
                        <div className='flex flex-col border-[1px] rounded-md bg-blue-light border-blue-light px-8 py-6 mr-2 mb-2'>
                            <p className='text-blue-400 font-semibold text-lg py-1'>Paso 2</p>
                            <h3 className='text-white font-semibold text-xl pb-4'>Diseño y desarrollo</h3>
                            <p className='text-white'>Armados con un plan sólido, nuestros equipos capacitados se hacen cargo. Ellos diseñarán y construirán sus soluciones digitales, con un enfoque principal en un sitio web atractivo e innovador..</p>
                        </div>
                    </div>
                </motion.div>
                <motion.div
