...
//         {
//             heading: '¿Qué servicios ofrece nuestra Agencia Digital?',
...
//         },
//         {
//             heading: '¿Cómo puedo empezar a trabajar con ustedes?',
...
//         {
//             heading: '¿Qué resultados puedo esperar al colaborar con Digital Solutions?',
...
//         },
//         {
//             heading: '¿Qué diferencia a Digital Solutions de otras agencias de marketing digital? ',
//             description: "Ofrecemos servicios personalizados adaptados a los requisitos únicos de cada cliente. Nos enfocamos en diseñar estrategias innovadoras y ofrecer orientación experta, ayudando a nuestros clientes a lograr sus objetivos comerciales.",
//         },
//         {
//             heading: '¿Quiénes son los clientes típicos?',
...
//         },
//         {
//             heading: "¿Cuál es el costo de los servicios?",
...
//     return (
//         <section className={` faq-background 2xs:px-[1rem] md:px-[6rem] xl:px-[16rem] 2xl:px-[28rem] 3xl:px-[32rem] 2xl:py-20 lg:pb-6 lg:pt-20 2xs:py-6 transition duration-500 ease-in-out `} ref={ref} >
//             <div className=' flex 2xs:flex-col sm:flex-row w-full xs:px-4'>
//                 <motion.div 
//                     className='flex flex-col sm:w-1/2'
//                     ref={textRef}
//                     animate={animation}>
//                     <h3 className='font-semibold sm:text-4xl 2xs:text-2xl text-black pb-4'>Preguntas frecuentes</h3>
//                     <p className='text-black sm:pb-8 xs:pr-20 '>Si tiene más preguntas después de leerlas, no dude en enviarnos un mensaje..</p>
//                 </motion.div>
